<svelte:head>
    <title>ABE Services - Privacy</title>
</svelte:head>

<p align="center"><strong>ABE Services</strong></p>

<h2 align="center">Privacy Statement</h2>

<p align="center">(Last Updated 20/5/04)</p>

<blockquote>
    <p>ABE Services is committed to protecting your privacy. You can visit most pages on the ABE
        Services Pty Ltd web site without giving ABE Services any information about yourself.</p>
    <p>For you, as a customer, for the Compliance Data Management Service (CDMS) we do need some information,
        ...
        and all its built in CDMS.</p>
    <p>You, as the Customer,
        ...
        of such information and access.</p>
    ...
    <p>When registering as a
        ...
        number, and credit card number.</p>
    <p>ABE Services does NOT keep or store any details of your credit card.</p>
    <h4>Use of your Personal Information</h4>
    <p>ABE Services may use your personal information for the following purposes:</p>
    <ul>
        <li>To ensure our site and services are relevant to your needs;</li>
        <li>To deliver the CDMS, and perhaps newsletters;</li>
        <li>To help ABE Services, through the CDMS, create and publish solutions most relevant to you;</li>
        <li>To alert you to product
            and services upgrades, special offers, updated information and other new
            services from ABE Services, if you so request;
        </li>
        <li>To allow you access
            ...
            to:
            <ul>
                <li>conform to the edicts of the law or comply with legal process served on ABE Services</li>
                <li>protect and defend the rights or property of ABE Services, or</li>
                <li>act in urgent circumstances to protect the personal safety of ABE Services employees, users
                    of ABE Services products or services, or members of the public.
                </li>
            </ul>
        </li>
    </ul>
    <p>Your information may be stored and processed in Australia or any other country in which ABE Services host its
    ...
    <p>When you register, or
        ...
        they are considered an essential part of the service you have chosen.</p>
    ...
    <p>We will provide you with
        ...
        ABE Services on abeservices@outlook.com.</p>
    ...
    <p>ABE Services is
        ...
        SSL enabled.</p>
    <h4>Protection of Children's Personal Information</h4>
    <p>ABE Service&#8217;s web
        site and its CDMS are general audience sites and do not knowingly collect
        any personal information from children.</p>
    <h4>Use of Cookies</h4>
    <p>We use cookies within the secure area of our internet sites to ensure accurate information is provided
    ...
    <p>If you have questions regarding this statement, you should first contact ABE Services by
        e-mail on <a href="mailto:abeservices@outlook.com">abeservices@outlook.com</a>.</p>
    <h4>Changes to this Statement</h4>
    <p>ABE Services will occasionally update this privacy statement. When ABE Services does
    ...
    <p>ABE Services welcomes your comments regarding this privacy statement; please contact
        ABE Services by e-mail on <a href="mailto:abeservices@outlook.com">abeservices@outlook.com</a>.</p>
    <p>&nbsp;</p></blockquote>
