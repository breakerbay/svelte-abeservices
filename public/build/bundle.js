...
var app = (function () {
    ...
    /* src/cas/CasHome.svelte generated by Svelte v3.38.3 */

    const file$k = "src/cas/CasHome.svelte";
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t12 = space();
    			p1 = element("p");
    			p1.textContent = "The CDMS enables the checking\n            of work on site using hand held devices (i.e. Palm Pilots) and the efficient\n            management of the compliance data via an Internet connection to a remote computer\n            database.";
    			t14 = space();
    			ul1 = element("ul");
    			li3 = element("li");
    			a3 = element("a");
    			a3.textContent = "More about the CDMS and how it works";
    			t16 = space();
    			li4 = element("li");
    			a4 = element("a");
    			a4.textContent = "More about the CDMS for Contractors and Subcontractors";
    			t18 = space();
    			li5 = element("li");
    			a5 = element("a");
    			a5.textContent = "More about the CDMS for Clients, Superintendents and others engaging and\n                monitoring contractors.";
    			document.title = "ABE Services - CAS";
    			add_location(h1, file$k, 9, 8, 112);
    			attr_dev(p0, "align", "center");
    			add_location(p0, file$k, 10, 8, 154);
    			attr_dev(a0, "href", "#/how");
    			add_location(a0, file$k, 15, 16, 440);
    			add_location(li0, file$k, 15, 12, 436);
    			attr_dev(a1, "href", "#/contractors");
    			add_location(a1, file$k, 16, 16, 518);
    			add_location(li1, file$k, 16, 12, 514);
    			attr_dev(a2, "href", "#/clients");
    			add_location(a2, file$k, 17, 16, 622);
    			add_location(li2, file$k, 17, 12, 618);
    			add_location(ul0, file$k, 14, 8, 419);
    			add_location(div0, file$k, 8, 4, 98);
    			add_location(h2, file$k, 22, 8, 807);
    			attr_dev(p1, "align", "center");
    			add_location(p1, file$k, 23, 8, 829);
    			attr_dev(a3, "href", "#/how");
    			add_location(a3, file$k, 28, 16, 1115);
    			add_location(li3, file$k, 28, 12, 1111);
    			attr_dev(a4, "href", "#/contractors");
    			add_location(a4, file$k, 29, 16, 1193);
    			add_location(li4, file$k, 29, 12, 1189);
    			attr_dev(a5, "href", "#/clients");
    			add_location(a5, file$k, 30, 16, 1297);
    			add_location(li5, file$k, 30, 12, 1293);
    			add_location(ul1, file$k, 27, 8, 1094);
    			add_location(div1, file$k, 21, 4, 793);
    			add_location(div2, file$k, 7, 0, 88);
    		},
    		l: function claim(nodes) {
    ...
    function instance$l($$self, $$props) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("CasHome", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<CasHome> was created with unknown prop '${key}'`);
    	});

    	return [];
    }

    class CasHome extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$j, 9, 4, 188);
    			attr_dev(h1, "align", "center");
    			attr_dev(h1, "class", "svelte-1tdqz32");
    			add_location(h1, file$j, 10, 4, 251);
    			attr_dev(h2, "align", "center");
    			add_location(h2, file$j, 11, 4, 284);
    			attr_dev(p1, "align", "center");
    			add_location(p1, file$j, 12, 4, 346);
    			attr_dev(p2, "align", "center");
    			add_location(p2, file$j, 15, 8, 440);
    			attr_dev(a0, "href", "#/how");
    			add_location(a0, file$j, 20, 16, 726);
    			add_location(li0, file$j, 20, 12, 722);
    			attr_dev(a1, "href", "#/contractors");
    			add_location(a1, file$j, 21, 16, 804);
    			add_location(li1, file$j, 21, 12, 800);
    			attr_dev(a2, "href", "#/clients");
    			add_location(a2, file$j, 22, 16, 908);
    			add_location(li2, file$j, 22, 12, 904);
    			add_location(ul, file$j, 19, 8, 705);
    			add_location(div0, file$j, 14, 4, 426);
    			add_location(p3, file$j, 33, 12, 1384);
    			add_location(p4, file$j, 34, 12, 1502);
    			attr_dev(a3, "href", "mailto:abeservices@outlook.com");
    			add_location(a3, file$j, 35, 71, 1644);
    			add_location(strong, file$j, 35, 15, 1588);
    			add_location(p5, file$j, 35, 12, 1585);
    			add_location(blockquote, file$j, 32, 8, 1359);
    			attr_dev(div1, "align", "center");
    			add_location(div1, file$j, 31, 4, 1330);
    			attr_dev(div2, "align", "center");
    			add_location(div2, file$j, 8, 0, 163);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$i = "src/cdms/body/Clients.svelte";
    ...
    function create_fragment$j(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			strong2.textContent = "demonstration\n                of accountability";
    			t28 = text(".");
    			t29 = space();
    			p2 = element("p");
    			p2.textContent = " ";
    			...
    			add_location(h2, file$i, 4, 0, 72);
    			add_location(hr, file$i, 5, 0, 140);
    			add_location(p0, file$i, 7, 4, 162);
    			add_location(td0, file$i, 11, 12, 307);
    			add_location(tr0, file$i, 10, 8, 290);
    			add_location(td1, file$i, 15, 12, 457);
    			add_location(tr1, file$i, 14, 8, 440);
    			add_location(td2, file$i, 20, 12, 682);
    			add_location(tr2, file$i, 19, 8, 665);
    			attr_dev(table0, "width", "863");
    			attr_dev(table0, "border", "0");
    			add_location(table0, file$i, 9, 4, 251);
    			add_location(p1, file$i, 24, 4, 826);
    			add_location(strong0, file$i, 30, 37, 1151);
    			add_location(em0, file$i, 30, 33, 1147);
    			add_location(td3, file$i, 30, 12, 1126);
    			add_location(tr3, file$i, 29, 8, 1109);
    			add_location(strong1, file$i, 35, 28, 1353);
    			add_location(em1, file$i, 35, 24, 1349);
    			add_location(td4, file$i, 35, 12, 1337);
    			add_location(tr4, file$i, 34, 8, 1320);
    			add_location(td5, file$i, 40, 12, 1545);
    			add_location(tr5, file$i, 39, 8, 1528);
    			add_location(td6, file$i, 44, 12, 1642);
    			add_location(tr6, file$i, 43, 8, 1625);
    			add_location(strong2, file$i, 48, 34, 1815);
    			add_location(em2, file$i, 48, 30, 1811);
    			add_location(td7, file$i, 48, 12, 1793);
    			add_location(tr7, file$i, 47, 8, 1776);
    			attr_dev(table1, "width", "859");
    			attr_dev(table1, "border", "0");
    			add_location(table1, file$i, 28, 4, 1070);
    			add_location(p2, file$i, 52, 4, 1922);
    			add_location(blockquote0, file$i, 53, 4, 1940);
    			add_location(blockquote1, file$i, 6, 0, 145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			p0 = element("p");
    			p0.textContent = "The CAS makes demonstrating compliance on construction projects easy.";
    			t4 = space();
    			div0 = element("div");
    			ol = element("ol");
    			li0 = element("li");
    			strong0 = element("strong");
    			strong0.textContent = "The CAS Concept";
    			t6 = space();
    			li1 = element("li");
    			strong1 = element("strong");
    			strong1.textContent = "Using the CAS on Projects";
    			t8 = space();
    			li2 = element("li");
    			strong2 = element("strong");
    			strong2.textContent = "Getting started";
    			t10 = space();
    			li3 = element("li");
    			strong3 = element("strong");
    			strong3.textContent = "Setting up ITP's";
    			t12 = space();
    			li4 = element("li");
    			strong4 = element("strong");
    			strong4.textContent = "Recording data";
    			t14 = space();
    			li5 = element("li");
    			strong5 = element("strong");
    			strong5.textContent = "Viewing reports";
    			t16 = space();
    			li6 = element("li");
    			strong6 = element("strong");
    			strong6.textContent = "Providing access to others";
    			t18 = space();
    			blockquote1 = element("blockquote");
    			h40 = element("h4");
    			h40.textContent = "The CAS Concept";
    			t20 = space();
    			h3 = element("h3");
    			img = element("img");
    			t21 = space();
    			p1 = element("p");
    			p1.textContent = "The diagram identifies the three major elements of the CAS:";
    			t23 = space();
    			p2 = element("p");
    			t24 = text("1. The preparation and authorisation of Inspection and Test Plans (ITP's) on a remote database,");
    			br0 = element("br");
    			t25 = text("\r\n            2. The collection of data ‘in the field’ by:");
    			t26 = space();
    			blockquote0 = element("blockquote");
    			p3 = element("p");
    			t27 = text("a. Accessing the ITP's on a mobile device - e.g. an Apple iphone or android phone such as a Samsung");
    			br1 = element("br");
    			t28 = text("\r\n                b. Marking off completed tasks on the mobile device at the workface,");
    			br2 = element("br");
    			t29 = text("\r\n                c. Uploading the completed tasks from the mobile device to the database, and finally");
    			t30 = space();
    			p4 = element("p");
    			p4.textContent = "3. The viewing/printing of reports on the status of the ITP's.";
    			t32 = space();
    			h41 = element("h4");
    			h41.textContent = "Using the CAS on Projects";
    			t34 = space();
    			p5 = element("p");
    			t35 = text("The CAS manages the development and sign-off of checking of work on a ");
    			strong7 = element("strong");
    			strong7.textContent = "Project.";
    			t37 = text(" ");
    			strong8 = element("strong");
    			strong8.textContent = "Inspection\r\n                and Test Plans (ITP's)";
    			t39 = text(" are the tool used to plan the checking\r\n            of work (i.e. the inspection and test processes) for activities on a construction\r\n            project.   ITP's are the central plank of Quality Assurance on\r\n            construction projects.");
    			t40 = space();
    			p6 = element("p");
    			t41 = text("Each ");
    			strong9 = element("strong");
    			strong9.textContent = "Project";
    			t43 = text(" has\r\n            one or more ");
    			strong10 = element("strong");
    			strong10.textContent = "ITP's";
    			t45 = text("covering the activities on the project,\r\n            e.g. for bricklaying, roofing, etc.");
    			strong11 = element("strong");
    			strong11.textContent = "  ";
    			t47 = text("In the CAS an ");
    			strong12 = element("strong");
    			strong12.textContent = "ITP";
    			t49 = text(" contains\r\n            a number of steps that define the process for doing the work (called ");
    			strong13 = element("strong");
    			strong13.textContent = "Process\r\n                Steps";
    			t51 = text(") and the points at which checks (verification) are carried\r\n            out (called ");
    			strong14 = element("strong");
    			strong14.textContent = "Verification Points";
    			t53 = text(").");
    			t54 = space();
    			p7 = element("p");
    			strong15 = element("strong");
    			strong15.textContent = "Process Steps ";
    			t56 = text("are\r\n            the steps taken to deliver the work. ");
    			strong16 = element("strong");
    			strong16.textContent = "Verification Points";
    			t58 = text(" define\r\n            the checks to be done at specific points in the work process to confirm/demonstrate\r\n            compliance with specified requirements.  On the CAS web site both ");
    			strong17 = element("strong");
    			strong17.textContent = "Process\r\n                Steps";
    			t60 = text(" and ");
    			strong18 = element("strong");
    			strong18.textContent = "Verification Points";
    			t62 = text(" are visible but\r\n            only ");
    			strong19 = element("strong");
    			strong19.textContent = "Verification Points ";
    			t64 = text("are downloaded onto the PDA (Palm).");
    			t65 = space();
    			p8 = element("p");
    			strong20 = element("strong");
    			strong20.textContent = "Verification Points ";
    			t67 = text("have\r\n            one or more ");
    			strong21 = element("strong");
    			strong21.textContent = "Criteria";
    			t69 = text(" setting\r\n            out in detail what specified requirements must be met.");
    			t70 = space();
    			p9 = element("p");
    			t71 = text("A ");
    			strong22 = element("strong");
    			strong22.textContent = "Verification\r\n            Point ";
    			t73 = text("may have some explanation attached to it, defined in a");
    			strong23 = element("strong");
    			strong23.textContent = "Details ";
    			t75 = text("section,\r\n            explaining the relevance of the ");
    			strong24 = element("strong");
    			strong24.textContent = "Verification Point,";
    			t77 = text(" such\r\n            as references to relevant industry standards.");
    			t78 = space();
    			p10 = element("p");
    			t79 = text("Additionally, there is\r\n            the provision on the PDA to record ");
    			strong25 = element("strong");
    			strong25.textContent = "Follow up Actions";
    			t81 = text(" when\r\n            a ");
    			strong26 = element("strong");
    			strong26.textContent = "Verification Point";
    			t83 = text(" can't be ticked off the first time\r\n            it is checked.  (In the Quality Assurance Standard ISO 9001:2000 these\r\n            are termed a non-conformance. The CAS provides a very easy way to record\r\n            these.  This helps control work and provides valuable feedback to\r\n            identify improvements.)");
    			t84 = space();
    			p11 = element("p");
    			strong27 = element("strong");
    			strong27.textContent = "ITP's";
    			t86 = text(" are\r\n            assigned ");
    			strong28 = element("strong");
    			strong28.textContent = "Work Lots.";
    			t88 = text(" A ");
    			strong29 = element("strong");
    			strong29.textContent = "Work Lot";
    			t90 = text(" defines\r\n            the work that is covered by the check being undertaken.  As an example\r\n            an ");
    			strong30 = element("strong");
    			strong30.textContent = "ITP (";
    			t92 = text("for say \"Roof Cladding\") may have assigned\r\n            to it two or more ");
    			strong31 = element("strong");
    			strong31.textContent = "Work Lots, ";
    			t94 = text("e.g. for the East side of the\r\n            building and for the West side of the building.");
    			t95 = space();
    			h42 = element("h4");
    			h42.textContent = "Getting started";
    			t97 = space();
    			p12 = element("p");
    			p12.textContent = "To get started a user\r\n            first needs to sign up with ABE Services Pty Ltd. Once signed up the user\r\n            will be provided with a password to access the CAS. The initial user will\r\n            be given access as an administrator. As an administrator the user will\r\n            be able to assign any other licence holders as an administrator or a checker.";
    			t99 = space();
    			p13 = element("p");
    			p13.textContent = "An administrator has\r\n            the ability to establish projects, create/modify ITP's and associated work\r\n            lots, and assigns specific ITP's to individual Checkers. A Checker, on\r\n            the other hand can only complete the activities viewed on his/her allocated\r\n            PDA, as well being able to download and upload data to the PDA.";
    			t101 = space();
    			h43 = element("h4");
    			h43.textContent = "Setting up ITP’s";
    			t103 = space();
    			p14 = element("p");
    			p14.textContent = "The process of developing\r\n            ITP's has been simplified by the provision of industry standard ITP templates.\r\n            These templates are provided to users either directly by ABE Services Pty\r\n            Ltd, or by a relevant industry association to its members.";
    			t105 = space();
    			p15 = element("p");
    			t106 = text("These ITP templates\r\n            can be copied into a user area and then into a project and used as is,\r\n            or modified to suit the particular project. If needed the user can create\r\n            ITP's from scratch. Because ITP's for a project are drawn from a list\r\n            of templates developed/copied/modified by the user, then these user templates\r\n            can be used over and over again from project to project. In fact entire\r\n            projects can be copied to like projects to further speed up ITP preparation.");
    			br3 = element("br");
    			t107 = text("\r\n            The setting up of projects and ITP's is undertaken by the user assigned\r\n            the role of administrator.");
    			t108 = space();
    			h44 = element("h4");
    			h44.textContent = "Recording data";
    			t110 = space();
    			p16 = element("p");
    			p16.textContent = "When ready to undertake\r\n            an inspection to collect compliance data, the Checker would synchronise\r\n            his/her PDA with the remote database to download the compliance/inspection\r\n            documentation to the PDA.";
    			t112 = space();
    			p17 = element("p");
    			p17.textContent = "The user then takes\r\n            the PDA ‘into the field’ and completes the\r\n            activities required by the compliance/inspection planning documentation\r\n            loaded  onto the PDA, by recording data into the mobile device as required\r\n            by the downloaded  documentation.";
    			t114 = space();
    			p18 = element("p");
    			p18.textContent = "The data recorded either\r\n            confirms compliance with requirements, or where compliance cannot be achieved,\r\n            identifies a follow-up action to be undertaken before a subsequent inspection\r\n            is carried out. The action also identifies if there are client requirements\r\n            to be addressed.";
    			t116 = space();
    			p19 = element("p");
    			p19.textContent = "On completion of inspection\r\n            activities the user synchronises the PDA with the database, uploading the\r\n            data collected.";
    			t118 = space();
    			p20 = element("p");
    			p20.textContent = "The uploaded data populates\r\n            the compliance/inspection documentation to provide a record of compliance\r\n            actions.";
    			t120 = space();
    			p21 = element("p");
    			p21.textContent = "All activity on the PDA is date stamped.";
    			t122 = space();
    			h45 = element("h4");
    			h45.textContent = "Viewing reports";
    			t124 = space();
    			p22 = element("p");
    			p22.textContent = "The user can review ITP's\r\n            and associated compliance data in an appropriate reporting format (onscreen\r\n            or printed reports). Reports available cover the ITP, the ITP with collected\r\n            data (the name of the checker, the data and time when each activity was signed\r\n            off, work lots used and non-conformance reports.";
    			t126 = space();
    			h46 = element("h4");
    			h46.textContent = "Providing access to others";
    			t128 = space();
    			p23 = element("p");
    			p23.textContent = "If the administrator\r\n            wishes to, the administrator can grant to external parties an  on line\r\n            view of the ITP's and other reports. This allows project compliance information\r\n            to be shared with others (clients, superintendents, project managers) in\r\n            real time. These external users may only view data. They cannot alter data.";
    			document_1.title = "ABE Services - How It Works";
    			attr_dev(h2, "align", "center");
    			add_location(h2, file$h, 11, 4, 283);
    			attr_dev(p0, "align", "center");
    			add_location(p0, file$h, 13, 8, 346);
    			add_location(strong0, file$h, 26, 16, 1030);
    			add_location(li0, file$h, 26, 12, 1026);
    			add_location(strong1, file$h, 27, 16, 1085);
    			add_location(li1, file$h, 27, 12, 1081);
    			add_location(strong2, file$h, 28, 16, 1150);
    			add_location(li2, file$h, 28, 12, 1146);
    			add_location(strong3, file$h, 29, 16, 1205);
    			add_location(li3, file$h, 29, 12, 1201);
    			add_location(strong4, file$h, 30, 16, 1261);
    			add_location(li4, file$h, 30, 12, 1257);
    			add_location(strong5, file$h, 31, 16, 1315);
    			add_location(li5, file$h, 31, 12, 1311);
    			add_location(strong6, file$h, 32, 16, 1370);
    			add_location(li6, file$h, 32, 12, 1366);
    			add_location(ol, file$h, 16, 8, 563);
    			attr_dev(div0, "class", "table-of-contents svelte-uvrrvh");
    			add_location(div0, file$h, 15, 8, 522);
    			add_location(div1, file$h, 12, 4, 331);
    			add_location(h40, file$h, 38, 8, 1491);
    			if (img.src !== (img_src_value = "images/how-it-works.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "width", "720");
    			attr_dev(img, "height", "540");
    			add_location(img, file$h, 39, 27, 1544);
    			attr_dev(h3, "align", "center");
    			add_location(h3, file$h, 39, 8, 1525);
    			add_location(p1, file$h, 40, 8, 1619);
    			add_location(br0, file$h, 41, 106, 1793);
    			add_location(p2, file$h, 41, 8, 1695);
    			add_location(br1, file$h, 44, 114, 2009);
    			add_location(br2, file$h, 45, 84, 2099);
    			add_location(p3, file$h, 44, 12, 1907);
    			add_location(blockquote0, file$h, 43, 8, 1881);
    			add_location(p4, file$h, 48, 8, 2242);
    			add_location(h41, file$h, 49, 8, 2321);
    			add_location(strong7, file$h, 50, 81, 2438);
    			add_location(strong8, file$h, 50, 113, 2470);
    			add_location(p5, file$h, 50, 8, 2365);
    			add_location(strong9, file$h, 55, 16, 2816);
    			add_location(strong10, file$h, 56, 24, 2870);
    			add_location(strong11, file$h, 57, 47, 2980);
    			add_location(strong12, file$h, 57, 85, 3018);
    			add_location(strong13, file$h, 58, 81, 3130);
    			add_location(strong14, file$h, 60, 24, 3262);
    			add_location(p6, file$h, 55, 8, 2808);
    			add_location(strong15, file$h, 61, 11, 3318);
    			add_location(strong16, file$h, 62, 49, 3403);
    			add_location(strong17, file$h, 64, 83, 3628);
    			add_location(strong18, file$h, 65, 35, 3680);
    			add_location(strong19, file$h, 66, 17, 3751);
    			add_location(p7, file$h, 61, 8, 3315);
    			add_location(strong20, file$h, 67, 19, 3848);
    			add_location(strong21, file$h, 68, 24, 3915);
    			add_location(p8, file$h, 67, 8, 3837);
    			add_location(strong22, file$h, 70, 13, 4035);
    			add_location(strong23, file$h, 71, 81, 4138);
    			add_location(strong24, file$h, 72, 44, 4218);
    			add_location(p9, file$h, 70, 8, 4030);
    			add_location(strong25, file$h, 75, 47, 4412);
    			add_location(strong26, file$h, 76, 14, 4467);
    			add_location(p10, file$h, 74, 8, 4338);
    			add_location(strong27, file$h, 81, 11, 4850);
    			add_location(strong28, file$h, 82, 21, 4899);
    			add_location(strong29, file$h, 82, 51, 4929);
    			add_location(strong30, file$h, 84, 15, 5068);
    			add_location(strong31, file$h, 85, 30, 5174);
    			add_location(p11, file$h, 81, 8, 4847);
    			add_location(h42, file$h, 88, 8, 5385);
    			add_location(p12, file$h, 89, 8, 5419);
    			add_location(p13, file$h, 94, 8, 5806);
    			add_location(h43, file$h, 100, 8, 6261);
    			add_location(p14, file$h, 101, 8, 6302);
    			add_location(br3, file$h, 111, 88, 7138);
    			add_location(p15, file$h, 105, 8, 6595);
    			add_location(h44, file$h, 115, 8, 7360);
    			add_location(p16, file$h, 116, 8, 7393);
    			add_location(p17, file$h, 120, 8, 7645);
    			add_location(p18, file$h, 125, 8, 7971);
    			add_location(p19, file$h, 130, 8, 8316);
    			add_location(p20, file$h, 133, 8, 8477);
    			add_location(p21, file$h, 136, 8, 8631);
    			add_location(h45, file$h, 138, 8, 8768);
    			add_location(p22, file$h, 139, 8, 8802);
    			add_location(h46, file$h, 155, 8, 9754);
    			add_location(p23, file$h, 156, 8, 9799);
    			add_location(blockquote1, file$h, 37, 4, 1469);
    			attr_dev(div2, "align", "left");
    			add_location(div2, file$h, 10, 0, 259);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(blockquote1, h40);
    			append_dev(blockquote1, t20);
    			append_dev(blockquote1, h3);
    			append_dev(h3, img);
    			append_dev(blockquote1, t21);
    			append_dev(blockquote1, p1);
    			...
    			append_dev(blockquote1, t32);
    			append_dev(blockquote1, h41);
    			append_dev(blockquote1, t34);
    			append_dev(blockquote1, p5);
    			append_dev(p5, t35);
    			append_dev(p5, strong7);
    			append_dev(p5, t37);
    			append_dev(p5, strong8);
    			append_dev(p5, t39);
    			append_dev(blockquote1, t40);
    			append_dev(blockquote1, p6);
    			append_dev(p6, t41);
    			append_dev(p6, strong9);
    			append_dev(p6, t43);
    			append_dev(p6, strong10);
    			append_dev(p6, t45);
    			append_dev(p6, strong11);
    			append_dev(p6, t47);
    			append_dev(p6, strong12);
    			append_dev(p6, t49);
    			append_dev(p6, strong13);
    			append_dev(p6, t51);
    			append_dev(p6, strong14);
    			append_dev(p6, t53);
    			append_dev(blockquote1, t54);
    			append_dev(blockquote1, p7);
    			append_dev(p7, strong15);
    			append_dev(p7, t56);
    			append_dev(p7, strong16);
    			append_dev(p7, t58);
    			append_dev(p7, strong17);
    			append_dev(p7, t60);
    			append_dev(p7, strong18);
    			append_dev(p7, t62);
    			append_dev(p7, strong19);
    			append_dev(p7, t64);
    			append_dev(blockquote1, t65);
    			append_dev(blockquote1, p8);
    			append_dev(p8, strong20);
    			append_dev(p8, t67);
    			append_dev(p8, strong21);
    			append_dev(p8, t69);
    			append_dev(blockquote1, t70);
    			append_dev(blockquote1, p9);
    			append_dev(p9, t71);
    			append_dev(p9, strong22);
    			append_dev(p9, t73);
    			append_dev(p9, strong23);
    			append_dev(p9, t75);
    			append_dev(p9, strong24);
    			append_dev(p9, t77);
    			append_dev(blockquote1, t78);
    			append_dev(blockquote1, p10);
    			append_dev(p10, t79);
    			append_dev(p10, strong25);
    			append_dev(p10, t81);
    			append_dev(p10, strong26);
    			append_dev(p10, t83);
    			append_dev(blockquote1, t84);
    			append_dev(blockquote1, p11);
    			append_dev(p11, strong27);
    			append_dev(p11, t86);
    			append_dev(p11, strong28);
    			append_dev(p11, t88);
    			append_dev(p11, strong29);
    			append_dev(p11, t90);
    			append_dev(p11, strong30);
    			append_dev(p11, t92);
    			append_dev(p11, strong31);
    			append_dev(p11, t94);
    			append_dev(blockquote1, t95);
    			append_dev(blockquote1, h42);
    			append_dev(blockquote1, t97);
    			append_dev(blockquote1, p12);
    			append_dev(blockquote1, t99);
    			append_dev(blockquote1, p13);
    			append_dev(blockquote1, t101);
    			append_dev(blockquote1, h43);
    			append_dev(blockquote1, t103);
    			append_dev(blockquote1, p14);
    			append_dev(blockquote1, t105);
    			append_dev(blockquote1, p15);
    			append_dev(p15, t106);
    			append_dev(p15, br3);
    			append_dev(p15, t107);
    			append_dev(blockquote1, t108);
    			append_dev(blockquote1, h44);
    			append_dev(blockquote1, t110);
    			append_dev(blockquote1, p16);
    			append_dev(blockquote1, t112);
    			append_dev(blockquote1, p17);
    			append_dev(blockquote1, t114);
    			append_dev(blockquote1, p18);
    			append_dev(blockquote1, t116);
    			append_dev(blockquote1, p19);
    			append_dev(blockquote1, t118);
    			append_dev(blockquote1, p20);
    			append_dev(blockquote1, t120);
    			append_dev(blockquote1, p21);
    			append_dev(blockquote1, t122);
    			append_dev(blockquote1, h45);
    			append_dev(blockquote1, t124);
    			append_dev(blockquote1, p22);
    			append_dev(blockquote1, t126);
    			append_dev(blockquote1, h46);
    			append_dev(blockquote1, t128);
    			append_dev(blockquote1, p23);
    		},
    		p: noop,
    		i: noop,
    		o: noop,
    ...
    function instance$h($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, animateScroll });
    	return [];
    }
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "align", "center");
    			add_location(h2, file$7, 5, 4, 102);
    			attr_dev(p0, "align", "left");
    			add_location(p0, file$7, 8, 8, 168);
    			attr_dev(p1, "align", "left");
    			add_location(p1, file$7, 12, 8, 528);
    			add_location(li0, file$7, 16, 12, 759);
    			add_location(li1, file$7, 17, 12, 850);
    			add_location(li2, file$7, 18, 12, 908);
    			add_location(li3, file$7, 19, 12, 969);
    			add_location(li4, file$7, 20, 12, 1045);
    			add_location(ul, file$7, 15, 8, 741);
    			attr_dev(p2, "align", "left");
    			add_location(p2, file$7, 23, 8, 1124);
    			attr_dev(p3, "align", "left");
    			add_location(p3, file$7, 26, 8, 1307);
    			add_location(em0, file$7, 33, 40, 1893);
    			add_location(strong, file$7, 33, 32, 1885);
    			attr_dev(a0, "href", "#/contact");
    			add_location(a0, file$7, 33, 12, 1865);
    			attr_dev(p4, "align", "center");
    			add_location(p4, file$7, 32, 8, 1833);
    			add_location(u, file$7, 39, 58, 2268);
    			attr_dev(a1, "href", "#/news");
    			add_location(a1, file$7, 39, 41, 2251);
    			add_location(em1, file$7, 37, 24, 2051);
    			add_location(blockquote0, file$7, 37, 12, 2039);
    			attr_dev(div0, "align", "center");
    			add_location(div0, file$7, 36, 8, 2005);
    			add_location(blockquote1, file$7, 7, 4, 146);
    			attr_dev(div1, "align", "center");
    			add_location(div1, file$7, 4, 0, 76);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-5vurs6");
    			add_location(a, file$1, 79, 20, 2587);
    			attr_dev(li, "class", "svelte-5vurs6");
    			add_location(li, file$1, 78, 16, 2562);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(78:12) {#each navItems as item}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "middle-line svelte-5vurs6");
    			add_location(div0, file$1, 72, 12, 2270);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(`mobile-icon${/*showMobileMenu*/ ctx[0] ? " active" : ""}`) + " svelte-5vurs6"));
    			add_location(div1, file$1, 71, 8, 2163);
    			if (img.src !== (img_src_value = "abelogo3.gif")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "ABE Services Logo");
    			attr_dev(img, "class", "svelte-5vurs6");
    			add_location(img, file$1, 74, 6, 2323);
    			add_location(div2, file$1, 74, 1, 2318);
    			attr_dev(h3, "class", "logo svelte-5vurs6");
    			add_location(h3, file$1, 75, 1, 2379);
    			attr_dev(ul, "class", ul_class_value = "" + (null_to_empty(`navbar-list${/*showMobileMenu*/ ctx[0] ? " mobile" : ""}`) + " svelte-5vurs6"));
    			add_location(ul, file$1, 76, 8, 2448);
    			attr_dev(div3, "class", "inner svelte-5vurs6");
    			add_location(div3, file$1, 70, 4, 2135);
    			attr_dev(nav, "class", "svelte-5vurs6");
    			add_location(nav, file$1, 69, 0, 2125);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*showMobileMenu*/ 1 && div1_class_value !== (div1_class_value = "" + (null_to_empty(`mobile-icon${/*showMobileMenu*/ ctx[0] ? " active" : ""}`) + " svelte-5vurs6"))) {
    			...
    			if (dirty & /*showMobileMenu*/ 1 && ul_class_value !== (ul_class_value = "" + (null_to_empty(`navbar-list${/*showMobileMenu*/ ctx[0] ? " mobile" : ""}`) + " svelte-5vurs6"))) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "align", "center");
    			add_location(section, file, 9, 8, 234);
    			attr_dev(div0, "class", "main");
    			add_location(div0, file, 8, 4, 207);
    			attr_dev(a0, "href", "#/privacy");
    			add_location(a0, file, 19, 26, 617);
    			attr_dev(a1, "href", "#/acknowledgements");
    			add_location(a1, file, 19, 70, 661);
    			attr_dev(p0, "align", "center");
    			add_location(p0, file, 19, 8, 599);
    			attr_dev(p1, "align", "center");
    			add_location(p1, file, 20, 8, 723);
    			add_location(footer, file, 13, 4, 324);
