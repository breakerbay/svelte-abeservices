...
var app = (function () {
    ...
    const file$h = "src/components/Home.svelte";
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p0, file$h, 9, 4, 180);
    			attr_dev(h1, "align", "center");
    			attr_dev(h1, "class", "svelte-1uhjzxq");
    			add_location(h1, file$h, 10, 4, 243);
    			attr_dev(h2, "align", "center");
    			add_location(h2, file$h, 11, 4, 276);
    			attr_dev(p1, "align", "center");
    			add_location(p1, file$h, 12, 4, 338);
    			attr_dev(p2, "align", "center");
    			add_location(p2, file$h, 15, 8, 432);
    			attr_dev(a0, "href", "#/how");
    			add_location(a0, file$h, 20, 16, 718);
    			add_location(li0, file$h, 20, 12, 714);
    			attr_dev(a1, "href", "#/contractors");
    			add_location(a1, file$h, 21, 16, 796);
    			add_location(li1, file$h, 21, 12, 792);
    			attr_dev(a2, "href", "#/clients");
    			add_location(a2, file$h, 22, 16, 900);
    			add_location(li2, file$h, 22, 12, 896);
    			add_location(ul, file$h, 19, 8, 697);
    			add_location(div0, file$h, 14, 4, 418);
    			add_location(blockquote0, file$h, 8, 0, 163);
    			add_location(p3, file$h, 34, 8, 1378);
    			add_location(p4, file$h, 35, 8, 1492);
    			attr_dev(a3, "href", "mailto:abeservices@outlook.com");
    			add_location(a3, file$h, 36, 67, 1630);
    			add_location(strong, file$h, 36, 11, 1574);
    			add_location(p5, file$h, 36, 8, 1571);
    			add_location(blockquote1, file$h, 33, 4, 1357);
    			attr_dev(div1, "align", "center");
    			add_location(div1, file$h, 32, 0, 1332);
    			add_location(footer, file$h, 41, 0, 1747);
    		},
    		l: function claim(nodes) {
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p8, file$d, 38, 4, 2216);
    			add_location(p9, file$d, 43, 4, 2545);
    			add_location(h41, file$d, 44, 4, 2626);
    			add_location(p10, file$d, 45, 4, 2673);
    			add_location(li0, file$d, 47, 8, 2774);
    			add_location(li1, file$d, 48, 8, 2852);
    			add_location(li2, file$d, 49, 8, 2916);
    			add_location(li3, file$d, 50, 8, 3025);
    			add_location(li4, file$d, 60, 16, 3559);
    			add_location(li5, file$d, 61, 16, 3670);
    			add_location(li6, file$d, 62, 16, 3758);
    			add_location(ul0, file$d, 59, 12, 3537);
    			add_location(li7, file$d, 54, 8, 3223);
    			add_location(ul1, file$d, 46, 4, 2760);
    			add_location(p11, file$d, 68, 4, 4012);
    			add_location(h42, file$d, 72, 4, 4335);
    			add_location(p12, file$d, 73, 4, 4386);
    			add_location(h43, file$d, 80, 4, 4913);
    			add_location(p13, file$d, 81, 4, 4963);
    			add_location(h44, file$d, 85, 4, 5219);
    			add_location(p14, file$d, 86, 4, 5271);
    			add_location(h45, file$d, 96, 4, 6010);
    			add_location(p15, file$d, 97, 4, 6070);
    			add_location(h46, file$d, 100, 4, 6238);
    			add_location(p16, file$d, 101, 4, 6267);
    			add_location(h47, file$d, 107, 4, 6742);
    			attr_dev(a0, "href", "mailto:abeservices@outlook.com");
    			add_location(a0, file$d, 109, 18, 6905);
    			add_location(p17, file$d, 108, 4, 6794);
    			add_location(h48, file$d, 110, 4, 6984);
    			add_location(p18, file$d, 111, 4, 7024);
    			add_location(h49, file$d, 116, 4, 7376);
    			attr_dev(a1, "href", "mailto:abeservices@outlook.com");
    			add_location(a1, file$d, 118, 34, 7533);
    			add_location(p19, file$d, 117, 4, 7410);
    			add_location(p20, file$d, 119, 4, 7612);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 58, 20, 1882);
    			attr_dev(li, "class", "svelte-opf6vj");
    			add_location(li, file$1, 57, 16, 1857);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:12) {#each navItems as item}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text("\n            | ");
    			a2 = element("a");
    			a2.textContent = "Charges";
    			t7 = text(" | ");
    			a3 = element("a");
    			a3.textContent = "Privacy\n                Statement";
    			t9 = text(" | ");
    			a4 = element("a");
    			a4.textContent = "Acknowledgements";
    			t11 = space();
    			p1 = element("p");
    			...
    			add_location(a0, file, 14, 26, 336);
    			attr_dev(a1, "href", "#/terms");
    			add_location(a1, file, 14, 59, 369);
    			attr_dev(a2, "href", "#/charges");
    			add_location(a2, file, 15, 14, 411);
    			attr_dev(a3, "href", "#/privacy");
    			add_location(a3, file, 15, 48, 445);
    			attr_dev(a4, "href", "#/acknowledgements");
    			add_location(a4, file, 16, 32, 505);
    			attr_dev(p0, "align", "center");
    			add_location(p0, file, 14, 8, 318);
    			attr_dev(p1, "align", "center");
    			add_location(p1, file, 17, 8, 567);
