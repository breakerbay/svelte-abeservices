    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$1, 76, 20, 2418);
    			attr_dev(li, "class", "svelte-11w822f");
    			add_location(li, file$1, 75, 16, 2393);
    		},
    		m: function mount(target, anchor) {
